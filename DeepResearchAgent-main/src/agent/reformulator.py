...
class Reformulator:
    ...
    async def run(self, original_task: str, inner_messages, reformulation_model: Model) -> str:
        return await prepare_response(original_task, inner_messages, reformulation_model)
